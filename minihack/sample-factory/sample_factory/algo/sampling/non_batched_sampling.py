...
#            unique_env_id = self.worker_idx
#            unique_env_id += self.cfg.num_workers*self.split_idx
#            unique_env_id += self.cfg.num_workers*self.cfg.worker_num_splits*policy_id
#            unique_env_id += self.cfg.num_workers*self.cfg.worker_num_splits*self.cfg.num_policies*self.agent_idx
            traj_dict = dict(t_id=t_id, length=rollout_step, policy_id=policy_id, traj_buffer_idx=traj_buffer_idx, unique_env_id=unique_env_id, rollout_step=rollout_step)
