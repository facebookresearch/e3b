...
class MiniHackMultiRoomN4OpenDoor(MiniGridHack):
    def __init__(self, *args, **kwargs):
        kwargs["max_episode_steps"] = kwargs.pop("max_episode_steps", 120)
...
class MiniHackMultiRoomN8(MiniGridHack):
    def __init__(self, *args, **kwargs):
        kwargs["max_episode_steps"] = kwargs.pop("max_episode_steps", 240)
        super().__init__(*args, env_name="MiniGrid-MultiRoom-N8-v0", **kwargs)

class MiniHackMultiRoomN8OpenDoor(MiniGridHack):
    def __init__(self, *args, **kwargs):
        kwargs["max_episode_steps"] = kwargs.pop("max_episode_steps", 240)
        kwargs["door_state"] = kwargs.pop("door_state", "open")
        super().__init__(*args, env_name="MiniGrid-MultiRoom-N8-v0", **kwargs)
...
class MiniHackMultiRoomN12(MiniGridHack):
    def __init__(self, *args, **kwargs):
        kwargs["max_episode_steps"] = kwargs.pop("max_episode_steps", 480)
        super().__init__(*args, env_name="MiniGrid-MultiRoom-N12-v0", **kwargs)

class MiniHackMultiRoomN12OpenDoor(MiniGridHack):
    def __init__(self, *args, **kwargs):
        kwargs["max_episode_steps"] = kwargs.pop("max_episode_steps", 480)
        kwargs["door_state"] = kwargs.pop("door_state", "open")
        super().__init__(*args, env_name="MiniGrid-MultiRoom-N12-v0", **kwargs)
...
register(
    id="MiniHack-MultiRoom-N4-OpenDoor-v0",
    entry_point="minihack.envs.minigrid:MiniHackMultiRoomN4OpenDoor",
)
register(
...
register(
    id="MiniHack-MultiRoom-N8-v0",
    entry_point="minihack.envs.minigrid:MiniHackMultiRoomN8",
)
register(
    id="MiniHack-MultiRoom-N8-OpenDoor-v0",
    entry_point="minihack.envs.minigrid:MiniHackMultiRoomN8OpenDoor",
)
register(
...
class MiniHackMultiRoomN2LavaOpenDoor(MiniGridHack):
    def __init__(self, *args, **kwargs):
        kwargs["max_episode_steps"] = kwargs.pop("max_episode_steps", 40)
        kwargs["lava_walls"] = True
        kwargs["door_state"] = kwargs.pop("door_state", "open")        
...
class MiniHackMultiRoomN4LavaOpenDoor(MiniGridHack):
    def __init__(self, *args, **kwargs):
        kwargs["max_episode_steps"] = kwargs.pop("max_episode_steps", 120)
        kwargs["lava_walls"] = True
        kwargs["door_state"] = kwargs.pop("door_state", "open")        
...
class MiniHackMultiRoomN8Lava(MiniGridHack):
    def __init__(self, *args, **kwargs):
        kwargs["max_episode_steps"] = kwargs.pop("max_episode_steps", 240)
        kwargs["lava_walls"] = True
        super().__init__(*args, env_name="MiniGrid-MultiRoom-N8-v0", **kwargs)
...
class MiniHackMultiRoomN8LavaOpenDoor(MiniGridHack):
    def __init__(self, *args, **kwargs):
        kwargs["max_episode_steps"] = kwargs.pop("max_episode_steps", 240)
        kwargs["lava_walls"] = True
        kwargs["door_state"] = kwargs.pop("door_state", "open")        
...
class MiniHackMultiRoomN12Lava(MiniGridHack):
    def __init__(self, *args, **kwargs):
        kwargs["max_episode_steps"] = kwargs.pop("max_episode_steps", 480)
        kwargs["lava_walls"] = True
        super().__init__(*args, env_name="MiniGrid-MultiRoom-N12-v0", **kwargs)
...
class MiniHackMultiRoomN12LavaOpenDoor(MiniGridHack):
    def __init__(self, *args, **kwargs):
        kwargs["max_episode_steps"] = kwargs.pop("max_episode_steps", 480)
        kwargs["lava_walls"] = True
        kwargs["door_state"] = kwargs.pop("door_state", "open")        
...
register(
    id="MiniHack-MultiRoom-N2-Lava-OpenDoor-v0",
    entry_point="minihack.envs.minigrid:MiniHackMultiRoomN2LavaOpenDoor",
)
...
register(
    id="MiniHack-MultiRoom-N4-Lava-OpenDoor-v0",
    entry_point="minihack.envs.minigrid:MiniHackMultiRoomN4LavaOpenDoor",
)
...
register(
    id="MiniHack-MultiRoom-N8-Lava-v0",
    entry_point="minihack.envs.minigrid:MiniHackMultiRoomN8Lava",
)
register(
    id="MiniHack-MultiRoom-N8-Lava-OpenDoor-v0",
    entry_point="minihack.envs.minigrid:MiniHackMultiRoomN8LavaOpenDoor",
)
...
# MiniGrid: ExtremeMultiRoom without locked doors
...
register(
    id="MiniHack-LavaCrossingS13N7-v0",
    entry_point="minihack.envs.minigrid:MiniGridHack",
    kwargs={"env_name": "MiniGrid-LavaCrossingS13N7-v0"},
)
register(
    id="MiniHack-LavaCrossingS15N9-v0",
    entry_point="minihack.envs.minigrid:MiniGridHack",
    kwargs={"env_name": "MiniGrid-LavaCrossingS15N9-v0"},
)
register(
